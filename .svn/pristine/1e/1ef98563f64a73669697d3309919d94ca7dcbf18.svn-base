...
public class BForecastModelMSTLa extends BForecastModelM implements Serializable {
    ...
    /** full constructor */
    public BForecastModelMSTLa(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.bizobject.BBizData historyBizData, int dataPeriodNum, int trendDampingIsValid, Double trendDampingFactor, Double seasonSmoothingFactor) {
    ...
    /** default constructor */
    public BForecastModelMSTLa() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_STLA );
    }

    /** minimal constructor */
    public BForecastModelMSTLa(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, int dataPeriodNum, int trendDampingIsValid, Double trendDampingFactor, Double seasonSmoothingFactor) {
