...
//	}
	 ...
	 * 获取折合数据运行进度
	 */
	public String getKitRunningProgress(){
		return kitRefreshService.getRunningProgress();
	}
	
	public String refreshAmountForecastData() throws Exception{
		if(kitRefreshService.isRunningKit == true){
			return kitRefreshService.getRunningProgress();
		}
		kitRefreshService.initAmountHistoryData();
		kitRefreshService.initAmountForecastData();
