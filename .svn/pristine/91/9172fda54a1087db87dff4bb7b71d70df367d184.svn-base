...
public class UiPopbScope implements Serializable {
    ...
    /** persistent field */
    private Set<UiPopbScopeBizData> uiPopbScopeBizDatas;

    /** persistent field */
    private Set<UiPopbScopeProOrg> uiPopbScopeProOrgs;

    /** full constructor */
    public UiPopbScope(String uiCode, String code, String name, int isDefault, int isPeriodControl, int periodOffsetBegin, int periodOffsetEnd, int isDisplayControl, int isShowProduct, int isShowProductCharacter, String productCharacterType, int isShowOrganization, int isShowOrganizationCharacter, String organizationCharacterType, String description, String comments, Long version, dmdd.dmddjava.dataaccess.dataobject.ProductLayer productLayer, dmdd.dmddjava.dataaccess.dataobject.ProductCharacterLayer productCharacterLayer, dmdd.dmddjava.dataaccess.dataobject.OrganizationCharacterLayer organizationCharacterLayer, dmdd.dmddjava.dataaccess.dataobject.OperatorUser operatorUser, dmdd.dmddjava.dataaccess.dataobject.OrganizationLayer organizationLayer, Set<UiPopbScopeBizData> uiPopbScopeBizDatas, Set<UiPopbScopeProOrg> uiPopbScopeProOrgs) {
        this.uiCode = uiCode;
        this.code = code;
        this.name = name;
    ...
    /** minimal constructor */
    public UiPopbScope(String uiCode, String code, int isDefault, int isPeriodControl, int periodOffsetBegin, int periodOffsetEnd, int isDisplayControl, int isShowProduct, int isShowProductCharacter, int isShowOrganization, int isShowOrganizationCharacter, Set<UiPopbScopeBizData> uiPopbScopeBizDatas, Set<UiPopbScopeProOrg> uiPopbScopeProOrgs) {
        this.uiCode = uiCode;
        this.code = code;
        this.isDefault = isDefault;
        this.isPeriodControl = isPeriodControl;
    ...
    public UiPopbScope(Long id, String code, String name, String description, String comments,String uiCode) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.description = description;
    ...
    public Set<UiPopbScopeBizData> getUiPopbScopeBizDatas() {
        return this.uiPopbScopeBizDatas;
    }

    public void setUiPopbScopeBizDatas(Set<UiPopbScopeBizData> uiPopbScopeBizDatas) {
        this.uiPopbScopeBizDatas = uiPopbScopeBizDatas;
    }
    
    public void addUiPopbScopeBizData(UiPopbScopeBizData _uiPopbScopeBizData) {
    	...
    	{
    		this.uiPopbScopeBizDatas = new HashSet<UiPopbScopeBizData>();
    	}
    	_uiPopbScopeBizData.setUiPopbScope( this );
        this.uiPopbScopeBizDatas.add( _uiPopbScopeBizData );
    }     

    public Set<UiPopbScopeProOrg> getUiPopbScopeProOrgs() {
        return this.uiPopbScopeProOrgs;
    }

    public void setUiPopbScopeProOrgs(Set<UiPopbScopeProOrg> uiPopbScopeProOrgs) {
        this.uiPopbScopeProOrgs = uiPopbScopeProOrgs;
    }

    public void addUiPopbScopeProOrg(UiPopbScopeProOrg _uiPopbScopeProOrg) {
    	...
    	{
    		this.uiPopbScopeProOrgs = new HashSet<UiPopbScopeProOrg>();
    	}
	...
	public boolean equals( Object obj )
	{
		...
		UiPopbScope other = (UiPopbScope) obj;
		if ( id == null )
		{
