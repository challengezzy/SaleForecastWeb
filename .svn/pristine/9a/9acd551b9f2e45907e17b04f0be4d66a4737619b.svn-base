...
public class ForecastModelMSTEsa extends ForecastModelM implements Serializable {
	
	public final static long serialVersionUID = -1060000022;
    ...
    /** full constructor */
    public ForecastModelMSTEsa(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.dataobject.BizData historyBizData, Double levelSmoothingFactor, Double trendSmoothingFactor, int trendDampingIsValid, Double trendDampingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
    ...
    /** default constructor */
    public ForecastModelMSTEsa() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_STESA );
    }

    /** minimal constructor */
    public ForecastModelMSTEsa(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Double levelSmoothingFactor, Double trendSmoothingFactor, int trendDampingIsValid, Double trendDampingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
