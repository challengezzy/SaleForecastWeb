...
public class ForecastRunTaskItem implements Serializable {
    ...
    /** persistent field */
    private dmdd.dmddjava.dataaccess.dataobject.ForecastRunTask forecastRunTask;
    ...
    /** full constructor */
    public ForecastRunTaskItem(int seqNo, int isIgnoreErrorThreshold, int status, int result, String resultDetail, Date beginTime, Date endTime, Double et, Double mape, Double mad, Double ts, Double mse, String forecastInstCode, String forecastInstName, String forecastModelCode, String forecastModelName, int outlierAnalyzePeriodNum, Double errorThreshold, String comments, Long version, dmdd.dmddjava.dataaccess.dataobject.ProductLayer runProductLayer, dmdd.dmddjava.dataaccess.dataobject.ForecastRunTask forecastRunTask, dmdd.dmddjava.dataaccess.dataobject.OrganizationLayer runOrganizationLayer, dmdd.dmddjava.dataaccess.dataobject.ForecastInst forecastInst) {
        this.seqNo = seqNo;
    ...
    /** default constructor */
    public ForecastRunTaskItem() {
    }

    /** minimal constructor */
    public ForecastRunTaskItem(int seqNo, int isIgnoreErrorThreshold, int status, int result, String forecastInstCode, String forecastInstName, int outlierAnalyzePeriodNum, Double errorThreshold, dmdd.dmddjava.dataaccess.dataobject.ForecastRunTask forecastRunTask) {
        this.seqNo = seqNo;
        this.isIgnoreErrorThreshold = isIgnoreErrorThreshold;
        this.status = status;
        this.result = result;
    ...
    public dmdd.dmddjava.dataaccess.dataobject.ForecastRunTask getForecastRunTask() {
        return this.forecastRunTask;
    }

    public void setForecastRunTask(dmdd.dmddjava.dataaccess.dataobject.ForecastRunTask forecastRunTask) {
        this.forecastRunTask = forecastRunTask;
    }
	...
	public boolean equals( Object obj )
	{
		...
		ForecastRunTaskItem other = (ForecastRunTaskItem) obj;
