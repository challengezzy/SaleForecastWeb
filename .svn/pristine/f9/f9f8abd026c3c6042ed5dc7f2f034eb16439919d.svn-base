...
public class BForecastModelMSLEso extends BForecastModelM implements Serializable {
    ...
    /** full constructor */
    public BForecastModelMSLEso(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.bizobject.BBizData historyBizData, Double smoothingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
    ...
    /** default constructor */
    public BForecastModelMSLEso() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_SLESO );
    }

    /** minimal constructor */
    public BForecastModelMSLEso(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Double smoothingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
