...
public class BBizData implements Serializable {
    ...
    /** full constructor */
    public BBizData(String code, String name, int type, int source, int isValid, String description, String comments, Long version, Set<BBizDataDefItem> bizDataDefItems) {
        this.code = code;
        this.name = name;
        this.type = type;
        this.source = source;
