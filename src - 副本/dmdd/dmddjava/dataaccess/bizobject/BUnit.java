...
public class BUnit implements Serializable {
    ...
    /** full constructor */
    public BUnit(String code, String name, long exchangeRate, int isBase, String comments, Long version, dmdd.dmddjava.dataaccess.bizobject.BUnitGroup unitGroup) {
        this.code = code;
        this.name = name;
    ...
    /** minimal constructor */
    public BUnit(String code, String name, long exchangeRate, int isBase, dmdd.dmddjava.dataaccess.bizobject.BUnitGroup unitGroup) {
        this.code = code;
        this.name = name;
        this.exchangeRate = exchangeRate;
        this.isBase = isBase;
