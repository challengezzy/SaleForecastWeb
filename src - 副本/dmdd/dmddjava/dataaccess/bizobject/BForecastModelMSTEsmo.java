...
public class BForecastModelMSTEsmo extends BForecastModelM implements Serializable {
    ...
    /** full constructor */
    public BForecastModelMSTEsmo(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.bizobject.BBizData historyBizData, Double levelSmoothingFactor, Double trendSmoothingFactor, int trendDampingIsValid, Double trendDampingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
    ...
    /** default constructor */
    public BForecastModelMSTEsmo() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_STESMO );
    }

    /** minimal constructor */
    public BForecastModelMSTEsmo(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Double levelSmoothingFactor, Double trendSmoothingFactor, int trendDampingIsValid, Double trendDampingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
