...
public class BHistoryAdjustLogAdjustItem implements Serializable {
    ...
    /** full constructor */
    public BHistoryAdjustLogAdjustItem(int period, long oldValue, long newValue, String description, String comments, Long version, dmdd.dmddjava.dataaccess.bizobject.BHistoryAdjustLog historyAdjustLog, dmdd.dmddjava.dataaccess.bizobject.BBizData bizData, dmdd.dmddjava.dataaccess.bizobject.BOrganization organization, dmdd.dmddjava.dataaccess.bizobject.BProductCharacter productCharacter, dmdd.dmddjava.dataaccess.bizobject.BOrganizationCharacter organizationCharacter, dmdd.dmddjava.dataaccess.bizobject.BProduct product) {
        this.period = period;
    ...
    /** default constructor */
    public BHistoryAdjustLogAdjustItem() {
    }

    /** minimal constructor */
    public BHistoryAdjustLogAdjustItem(int period, long oldValue, long newValue, dmdd.dmddjava.dataaccess.bizobject.BHistoryAdjustLog historyAdjustLog) {
        this.period = period;
        this.oldValue = oldValue;
        this.newValue = newValue;
        this.historyAdjustLog = historyAdjustLog;
	...
	public boolean equals( Object obj )
	{
		...
		BHistoryAdjustLogAdjustItem other = (BHistoryAdjustLogAdjustItem) obj;
		if ( bizData == null )
		{
