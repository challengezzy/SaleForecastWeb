...
public class BForecastData implements Serializable {
    ...
    /** full constructor */
    public BForecastData(int period, long value, int status, Date initTime, Date updateTime, String comments, Long version, dmdd.dmddjava.dataaccess.bizobject.BBizData bizData, dmdd.dmddjava.dataaccess.bizobject.BOrganization organization, dmdd.dmddjava.dataaccess.bizobject.BProduct product) {
        this.period = period;
        this.value = value;
        this.status = status;
    ...
    /** default constructor */
    public BForecastData() {
    }

    /** minimal constructor */
    public BForecastData(int period, long value, int status, Date initTime, Date updateTime) {
        this.period = period;
        this.value = value;
        this.status = status;
        this.initTime = initTime;
	...
	public boolean equals( Object obj )
	{
		...
		if( getClass() != obj.getClass() )
			return false;
		BForecastData other = (BForecastData) obj;
		if( bizData == null )
		{
