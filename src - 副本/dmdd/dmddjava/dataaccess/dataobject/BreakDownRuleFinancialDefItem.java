...
public class BreakDownRuleFinancialDefItem implements Serializable
{
  ...
  /** persistent field */
    ...
    public BreakDownRuleFinancialDefItem()
    {
    	
    }
	public BreakDownRuleFinancialDefItem(Long id, Integer period,
			Integer beginDate, Integer endDate, Integer proportion,
			Long version, String weekCode, BreakDownRule breakDownRule) {
		super();
		this.id = id;
		this.period = period;
	...
	public dmdd.dmddjava.dataaccess.dataobject.BreakDownRule getBreakDownRule() {
		return breakDownRule;
	}

	public void setBreakDownRule(
			dmdd.dmddjava.dataaccess.dataobject.BreakDownRule breakDownRule) {
		this.breakDownRule = breakDownRule;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BreakDownRuleFinancialDefItem other = (BreakDownRuleFinancialDefItem) obj;
		if (proportion == null) {
	...
	public String toString() {
		return "BreakDownFinancialDefItem [Proportion=" + proportion
