...
public class ForecastErrorMappingModel implements Serializable {
    ...
    /** full constructor */
    public ForecastErrorMappingModel(String forecastInstCode, String forecastInstName, String forecastModelCode, String forecastModelName, int compilePeriod, int outlierAnalyzePeriodNum, Double errorThreshold, Double et, Double mape, Double mad, Double ts, Double mse, Date producedTime, String comments, Long version, dmdd.dmddjava.dataaccess.dataobject.ProductLayer runProductLayer, dmdd.dmddjava.dataaccess.dataobject.OrganizationLayer runOrganizationLayer) {
    ...
    /** default constructor */
    public ForecastErrorMappingModel() {
    }

    /** minimal constructor */
    public ForecastErrorMappingModel(String forecastInstCode, String forecastInstName, int compilePeriod, int outlierAnalyzePeriodNum, Double errorThreshold, Double et, Double mape, Double mad, Double ts, Double mse, Date producedTime) {
        this.forecastInstCode = forecastInstCode;
        this.forecastInstName = forecastInstName;
        this.compilePeriod = compilePeriod;
        this.outlierAnalyzePeriodNum = outlierAnalyzePeriodNum;
	...
	public boolean equals( Object obj )
	{
		...
		if( getClass() != obj.getClass() )
			return false;
		ForecastErrorMappingModel other = (ForecastErrorMappingModel) obj;
