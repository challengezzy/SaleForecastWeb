...
public class ForecastModelMSLEso extends ForecastModelM implements Serializable {
	
	public final static long serialVersionUID = -1060000017;
    ...
    /** full constructor */
    public ForecastModelMSLEso(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.dataobject.BizData historyBizData, Double smoothingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
    ...
    /** default constructor */
    public ForecastModelMSLEso() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_SLESO );
    }

    /** minimal constructor */
    public ForecastModelMSLEso(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Double smoothingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
