/**********************************************************************
 *$RCSfile:ForcastAssessmenetData.java,v $  $Revision: 1.0 $  $Date:2012-3-19 $
 *********************************************************************/ 
...
/**
 * <li>Title: ForcastAssessmenetData.java</li>
 ...
 * @version 1.0
 */
public class ForecastAssessmentData implements Serializable 
{
    ...
    /** full constructor */
    public ForecastAssessmentData(int period, Double value,  String comments, Long version, dmdd.dmddjava.dataaccess.dataobject.BizData bizData, dmdd.dmddjava.dataaccess.dataobject.Organization organization, dmdd.dmddjava.dataaccess.dataobject.Product product) {
        this.period = period;
        this.value = value;
	...
	public boolean equals( Object obj )
	{
		...
		if( getClass() != obj.getClass() )
			return false;
		ForecastAssessmentData other = (ForecastAssessmentData) obj;
		if( bizData == null )
		{
 ...
 *$RCSfile:ForcastAssessmenetData.java,v $  $Revision: 1.0 $  $Date:2012-3-19 $
 *
 *$Log:ForcastAssessmenetData.java,v $
 *********************************************************************/