...
public class ForecastModelMTEs extends ForecastModelM implements Serializable {
    ...
    /** full constructor */
    public ForecastModelMTEs(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.dataobject.BizData historyBizData, Double levelSmoothingFactor, Double trendSmoothingFactor, int trendDampingIsValid, Double trendDampingFactor, int initDataPeriodNum) {
    ...
    /** default constructor */
    public ForecastModelMTEs() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_TES );
    }

    /** minimal constructor */
    public ForecastModelMTEs(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Double levelSmoothingFactor, Double trendSmoothingFactor, int trendDampingIsValid, Double trendDampingFactor, int initDataPeriodNum) {
