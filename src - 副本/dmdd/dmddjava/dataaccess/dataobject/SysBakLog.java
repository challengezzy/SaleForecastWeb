...
public class SysBakLog implements Serializable {
    ...
    /** full constructor */
    public SysBakLog(Date excuteTime, int beginPeroid, int endPeroid, int bakHistoryData, int bakHistoryAdjustLog, int bakPriceData, int bakForecastData, int bakForecastMakeLog, String operatorUserName, String description, String comments) {
    ...
    /** minimal constructor */
    public SysBakLog(Date excuteTime, int beginPeroid, int endPeroid, int bakHistoryData, int bakHistoryAdjustLog, int bakPriceData, int bakForecastData, int bakForecastMakeLog, String operatorUserName) {
        this.excuteTime = excuteTime;
        this.beginPeroid = beginPeroid;
        this.endPeroid = endPeroid;
        this.bakHistoryData = bakHistoryData;
