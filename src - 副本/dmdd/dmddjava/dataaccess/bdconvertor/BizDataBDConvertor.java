...
public class BizDataBDConvertor implements BDConvertorInterface
{
	...
	public void btod(BBizData _bBizData, BizData _bizData, boolean _blWithBizDataDefItems )
	{
		if( _bizData == null )
		{
			return;
		...
		{
			if( _bBizData != null && _bBizData.getBizDataDefItems() != null && _bBizData.getBizDataDefItems().iterator() != null )
			{
				Iterator<BBizDataDefItem> itr_bBizDataDefItems = _bBizData.getBizDataDefItems().iterator();
				while( itr_bBizDataDefItems.hasNext() )
				{
					BBizDataDefItem bBizDataDefItem = itr_bBizDataDefItems.next();
					BizDataDefItemBDConvertor bizDataDefItemBDConvertor = UtilFactoryBizDataDefItem.getBizDataDefItemBDConvertorInstance( bBizDataDefItem );
					
					BizDataDefItem bizDataDefItem = (BizDataDefItem) bizDataDefItemBDConvertor.btod(bBizDataDefItem);
	...
	public void dtob(BizData _bizData, BBizData _bBizData, boolean _blWithBizDataDefItems)
	{
		if( _bBizData == null )
		{
			return;
		...
		if( _blWithBizDataDefItems == true )
		{
			if( _bizData != null && _bizData.getBizDataDefItems() != null && _bizData.getBizDataDefItems().iterator() != null )
			{
				Iterator<BizDataDefItem> itr_bizDataDefItems = _bizData.getBizDataDefItems().iterator();
				while( itr_bizDataDefItems.hasNext() )
				{
					BizDataDefItem bizDataDefItem = itr_bizDataDefItems.next();
					BizDataDefItemBDConvertor bizDataDefItemBDConvertor = UtilFactoryBizDataDefItem.getBizDataDefItemBDConvertorInstance( bizDataDefItem );
					
					BBizDataDefItem bBizDataDefItem = (BBizDataDefItem) bizDataDefItemBDConvertor.dtob(bizDataDefItem);
