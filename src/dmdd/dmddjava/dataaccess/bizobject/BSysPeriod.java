...
public class BSysPeriod implements Serializable {
    ...
    /** full constructor */
    public BSysPeriod(int compilePeriod, int historyValidPeriod, int forecastRunPeriod, int historyOpenPeriod, int forecastDispPeriod, int periodNumPerYear, String comments, Long version) {
    ...
    /** minimal constructor */
    public BSysPeriod(int compilePeriod, int historyValidPeriod, int forecastRunPeriod, int historyOpenPeriod, int forecastDispPeriod, int periodNumPerYear) {
        this.compilePeriod = compilePeriod;
        this.historyValidPeriod = historyValidPeriod;
        this.forecastRunPeriod = forecastRunPeriod;
        this.historyOpenPeriod = historyOpenPeriod;
