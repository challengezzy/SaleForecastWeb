/**********************************************************************
 *$RCSfile:BBreakDownRuleDefItem.java,v $  $Revision: 1.0 $  $Date:2012-3-26 $
 *********************************************************************/ 
...
/**
 * <li>Title: BBreakDownRuleDefItem.java</li>
 ...
 * @version 1.0
 */
public class BBreakDownRuleDefItem implements Serializable
{
    ...
    /** full constructor */
    public BBreakDownRuleDefItem(int isConnected,int period, int week1,int week2, int week3,int week4,int week5,int week6,String comments,Long version,int firstDay,int num_week,String weekCode, dmdd.dmddjava.dataaccess.bizobject.BBreakDownRule breakDownRule) {
    ...
    public BBreakDownRule getBreakDownRule()
    {
    	return this.breakDownRule;
    }
    
    public void setBreakDownRule(BBreakDownRule breakDownRule)
    {
    	this.breakDownRule = breakDownRule;
    }
	...
	public boolean equals( Object obj )
	{
		...
		if( getClass() != obj.getClass() )
			return false;
		BBreakDownRuleDefItem other = (BBreakDownRuleDefItem) obj;
		if( id == null )
		{
			if( other.id != null )
				return false;
 ...
 *$RCSfile:BBreakDownRuleDefItem.java,v $  $Revision: 1.0 $  $Date:2012-3-26 $
 *
 *$Log:BBreakDownRuleDefItem.java,v $
 *********************************************************************/