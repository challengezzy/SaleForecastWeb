...
public class BForecastModelMSLMa extends BForecastModelM implements Serializable {
    ...
    /** full constructor */
    public BForecastModelMSLMa(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.bizobject.BBizData historyBizData, int dataPeriodNum, Double seasonSmoothingFactor) {
    ...
    /** default constructor */
    public BForecastModelMSLMa() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_SLMA );
    }

    /** minimal constructor */
    public BForecastModelMSLMa(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, int dataPeriodNum, Double seasonSmoothingFactor) {
