...
public class BBizDataDefItemMoneyComb extends BBizDataDefItem implements Serializable {
    ...
    /** full constructor */
    public BBizDataDefItemMoneyComb(String indicator, Long version, dmdd.dmddjava.dataaccess.bizobject.BBizData bizData, Double coefficient, dmdd.dmddjava.dataaccess.bizobject.BBizData itemBizData) {
    ...
    /** default constructor */
    public BBizDataDefItemMoneyComb() {
    	this.setIndicator( BizConst.BIZDATADEFITEM_INDICATOR_MONEYCOMB );
    }

    /** minimal constructor */
    public BBizDataDefItemMoneyComb(String indicator, dmdd.dmddjava.dataaccess.bizobject.BBizData bizData, Double coefficient) {
	...
	public boolean equals( Object obj )
	{
		...
		BBizDataDefItemMoneyComb other = (BBizDataDefItemMoneyComb) obj;
		if ( itemBizData == null )
		{
