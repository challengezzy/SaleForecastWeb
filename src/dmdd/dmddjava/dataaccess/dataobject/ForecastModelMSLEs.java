...
public class ForecastModelMSLEs extends ForecastModelM implements Serializable {
    ...
    /** full constructor */
    public ForecastModelMSLEs(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.dataobject.BizData historyBizData, Double smoothingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
    ...
    /** default constructor */
    public ForecastModelMSLEs() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_SLES );
    }

    /** minimal constructor */
    public ForecastModelMSLEs(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Double smoothingFactor, Double seasonSmoothingFactor, int initDataPeriodNum) {
