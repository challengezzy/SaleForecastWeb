...
public class ForecastModelMSTCply extends ForecastModelM implements Serializable {
    ...
    /** full constructor */
    public ForecastModelMSTCply(String code, String name, int type, String indicator, int source, String description, String comments, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, Long version, dmdd.dmddjava.dataaccess.dataobject.BizData historyBizData, int dataPeriodNum, Double seasonSmoothingFactor) {
    ...
    /** default constructor */
    public ForecastModelMSTCply() {
    	this.setIndicator( BizConst.FORECASTMODELM_INDICATOR_STCPLY );
    }

    /** minimal constructor */
    public ForecastModelMSTCply(String code, String name, int type, String indicator, int source, Double outlierFactor, int outlierAnalyzePeriodNum, int outlierDataIsAutoAdjust, Double outlierDataAdjustHistoryWgt, Double outlierDataAdjustComputeWgt, int dataPeriodNum, Double seasonSmoothingFactor) {
