...
public class BizDataDefItemFcComb extends BizDataDefItem implements Serializable {
    ...
    /** full constructor */
    public BizDataDefItemFcComb(String indicator, Long version, dmdd.dmddjava.dataaccess.dataobject.BizData bizData, Double coefficient, dmdd.dmddjava.dataaccess.dataobject.BizData itemBizData) {
    ...
    /** default constructor */
    public BizDataDefItemFcComb() {
    	this.setIndicator( BizConst.BIZDATADEFITEM_INDICATOR_FCCOMB );
    }

    /** minimal constructor */
    public BizDataDefItemFcComb(String indicator, dmdd.dmddjava.dataaccess.dataobject.BizData bizData, Double coefficient) {
	...
	public boolean equals( Object obj )
	{
		...
		if( getClass() != obj.getClass() )
			return false;
		BizDataDefItemFcComb other = (BizDataDefItemFcComb) obj;
		if( itemBizData == null )
		{
